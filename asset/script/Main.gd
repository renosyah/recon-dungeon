...
var Room = preload("res://asset/scene/Room.tscn")
var Player = preload("res://asset/scene/player.tscn")
var font = preload("res://asset/fonts/montserrat_eb_32.tres")

onready var Map = $TileMap
onready var camera = $camera
onready var radomize_button = $CanvasLayer/radomize
